 ...
 * Description: Controlled AI image generator for portfolio project pages with modular providers, hidden project prompts, moderation, customisable galleries, prompt relevance checks, frontend text controls, and safe debug logging.
 * Version: 1.6.0
 * Author: Andy Hayes
...
require_once PAI_PLUGIN_DIR . 'includes/class-pai-relevance-guard.php';
